...
var DATA = {
  ...
  weapons: [
    ...
    { id: "militech_cowboy_u55", name: "Militech Cowboy U-55 Grenade Launcher", type: "Heavy Weapons", dmg: "varies (25mm)", hands: 2, rof: 1, mag: 12, conceal: "No", cost: 900, desc: "[CRB] Standard. Explosive." },
  ...
  cyberware: [
  {
    ...
    "hc": 7,
    "cost": 100,
    "desc": "[CRB] Single cybernetic eye.",
    "slots": 3,
    "bodyPart": "eye"
  },
  {
    ...
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Internal ear comms and audio processing.",
    "slots": 3
  },
  {
    "id": "neural_link",
    ...
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Chip socket interface. Required for most Neuralware.",
    "slots": 5
  },
  {
    "id": "chipware_socket",
    ...
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Extra skill chip socket.",
    "parentType": "neural_link"
  },
  {
    "id": "interface_plugs",
    ...
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Allows user to interface with cyberdecks, smartguns, vehicles.",
    "parentType": "neural_link"
  },
  {
    ...
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Record your experiences to braindance format.",
    "parentType": "neural_link"
  },
  {
    ...
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Analyze chemicals by touching or ingesting.",
    "parentType": "neural_link"
  },
  {
    "id": "machine_tech_link",
    "name": "Machine/Tech Link",
    "type": "Neuralware",
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Interface directly with machines/tech for control.",
    "parentType": "neural_link"
  },
  {
    "id": "pain_editor",
    ...
    "hc": 14,
    "cost": 1000,
    "desc": "[CRB] Disables pain. User ignores penalties due to being Seriously Wounded."
  },
  {
    "id": "nanosurgeons",
    "name": "Nanosurgeons",
    ...
    "hc": 3,
    "cost": 1500,
    "desc": "[CRB] Auto-stabilize at 0 HP once per day."
  },
  {
    "id": "synth_lungs",
    "name": "Synth Lungs",
    ...
    "hc": 3,
    "cost": 1000,
    "desc": "[CRB] Filter toxins, breathe smoke."
  },
  {
    "id": "gills",
    "name": "Gills",
  ...
  },
  {
    ...
    "hc": 7,
    "cost": 100,
    "desc": "[CRB] Enhanced touch, +1 to pick lock/pick pocket.",
    "parentType": "neural_link",
    "bonus": {
      "skills": {
        "pick_lock": 1,
  ...
  },
  {
    ...
    "hc": 7,
    "cost": 100,
    "desc": "[CRB] Enhanced smell, +2 to tracking via scent.",
    "parentType": "neural_link",
    "bonus": {
      "skills": {
        "tracking": 2
  ...
  },
  {
    ...
    "hc": 14,
    "cost": 1000,
    "desc": "[CRB] SP 7 to area implanted."
  },
  {
    "id": "skin_weave",
    "name": "Skin Weave",
  ...
  },
  {
    ...
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] +2 to BODY for melee damage."
  },
  {
    "id": "hydraulic_rams",
    "name": "Hydraulic Rams",
    ...
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] Cyberleg option, +2 MOVE when jumping.",
    "parentType": "cyberleg"
  },
  {
    "id": "big_knucks",
    ...
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] Brass knuckles built into cyberarm.",
    "parentType": "cyberarm"
  },
  {
    "id": "popup_weapon",
    "name": "Popup Weapon (Cyberarm)",
    "type": "Cyberarm Option",
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Hidden weapon in cyberarm.",
    "parentType": "cyberarm"
  },
  {
    "id": "implanted_lavatory",
    "name": "Implanted Lavatory",
    "type": "Internal Body",
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] Waste processing implant."
  },
  {
    "id": "light_tattoo",
    "name": "Light Tattoo",
    ...
    "hc": 2,
    "cost": 100,
    "desc": "[CRB] LED subdermal tattoos.",
    "bonus": {
      "skills": {
        "wardrobe_style": 2
      }
  ...
  },
  {
    ...
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] Always-on recording of everything you see/hear."
  },
  {
    "id": "buddy_link",
    "name": "Buddy Link",
    ...
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] Private short-range comm with your crew."
  },
  {
    "id": "bc_budget_chipware",
    "name": "Budget Chipware Socket",
    "type": "Neuralware",
    "hc": 7,
    "cost": 100,
    "desc": "[CRB] A cheap chipware socket.",
    "parentType": "neural_link"
  },
  {
    "id": "bc_discount_audio",
    "name": "Discount Cyberaudio Suite",
    "type": "Cyberaudio",
    "hc": 7,
    "cost": 100,
    "desc": "[CRB] An inferior audio suite at an affordable price.",
    "slots": 3,
    "parentType": "cyberaudio"
  },
  {
    "id": "bc_explicit_memory",
    "name": "Explicit Memory Stimulator",
    "type": "Chipware",
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] +2 to Concentration Checks to remember information.",
    "parentType": "neural_link",
    "bonus": {
      "skills": {
        "concentration": 2
  ...
  },
  {
    ...
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] Extra points of articulation. +2 Contortionist per limb (max +8 all limbs).",
    "bonus": {
      "skills": {
        "contortionist": 2
      }
  ...
  },
  {
    ...
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Blind your enemies with your arm.",
    "parentType": "cyberarm"
  },
  {
    "id": "bc_hardened_cybereye",
    "name": "Hardened Cybereye Casing",
    "type": "Cybereye",
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] Protect your Cybereye against EMP effects.",
    "parentType": "cybereye"
  },
  {
    "id": "bc_health_monitor",
    "name": "Heuristic Health Monitor",
    "type": "Fashionware",
    "hc": 0,
    "cost": 500,
    "desc": "[CRB] You're fit and now you can show the world."
  },
  {
    "id": "bc_integrated_cyberdeck",
    "name": "Integrated Cyberdeck Upgrade",
    "type": "Cyberarm",
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] An extra option slot for your arm-installed Cyberdeck.",
    "parentType": "cyberarm"
  },
  {
    "id": "bc_modular_finger_hand",
    "name": "Modular Finger Cyberhand",
    "type": "Cyberarm Option",
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] A hand for modular Cyberfingers.",
    "parentType": "cyberarm",
    "slots": 5
  },
  {
    "id": "bc_neo_soviet_arm",
    "name": "Neo-Soviet Cyberarm",
    "type": "Cyberarm",
    "hc": 7,
    "cost": 100,
    "desc": "[CRB] Neo-Soviet charm for your Cyberarm.",
    "bodyPart": "arm",
    "slots": 4,
    "parentType": "cyberarm"
  },
  {
    ...
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Shoot nets from your arm.",
    "parentType": "cyberarm"
  },
  {
    "id": "bc_popup_shotgun",
    ...
    "hc": 7,
    "cost": 1000,
    "desc": "[CRB] A shotgun in your arm.",
    "parentType": "cyberarm"
  },
  {
    "id": "bc_racerbracer",
    ...
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Immunity to Whiplash Critical Injury."
  },
  {
    "id": "bc_reflex_coprocessor",
    "name": "Reflex Co-Processor",
    "type": "Neuralware",
    "hc": 14,
    "cost": 500,
    "desc": "[CRB] Dodge bullets without REF 8.",
    "parentType": "neural_link"
  },
  {
    "id": "bc_reinforced_limb",
    "name": "Reinforced Cyberlimb Upgrade",
    "type": "Cyberlimb",
    "hc": 3,
    "cost": 1000,
    "desc": "[CRB] Say goodbye to breaking this limb."
  },
  {
    "id": "bc_sponsored_cybereye",
    "name": "Sponsored Cybereye",
    "type": "Cybereye",
    "hc": 7,
    "cost": 50,
    "desc": "[CRB] A cheap Cybereye with Chyron and pop-up ads.",
    "bodyPart": "eye",
    "slots": 3,
    "parentType": "cybereye"
  },
  {
    "id": "bc_trauma_nanomatrix",
    "name": "Trauma Response Nanomatrix",
    "type": "Internal Body",
    "hc": 7,
    "cost": 1000,
    "desc": "[CRB] Restore all lost Skinweave or Subdermal Armor SP once/day."
  },
  {
    "id": "bc_standard_cyberfinger",
    "name": "Standard Cyberfinger",
    "type": "Cyberfinger",
    "hc": 0,
    "cost": 20,
    "desc": "[CRB] A Cyberfinger with no special features. Requires Modular Finger Cyberhand.",
    "parentType": "bc_modular_finger_hand"
  },
  {
    "id": "bc_lockpick_cyberfinger",
    "name": "Lockpick Cyberfinger",
    "type": "Cyberfinger",
    "hc": 2,
    "cost": 100,
    "desc": "[CRB] Adjustable lockpick and tensioning tool. Requires Modular Finger Cyberhand.",
    "parentType": "bc_modular_finger_hand"
  },
  {
    "id": "bc_microphone_cyberfinger",
    "name": "Microphone Cyberfinger",
    "type": "Cyberfinger",
    "hc": 2,
    "cost": 100,
    "desc": "[CRB] Microphone linked to Agent or recording device. Requires Modular Finger Cyberhand.",
    "parentType": "bc_modular_finger_hand"
  },
  {
    "id": "bc_lighter_cyberfinger",
    "name": "Lighter Cyberfinger",
    "type": "Cyberfinger",
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] Lighter concealed in the tip. Requires Modular Finger Cyberhand.",
    "parentType": "bc_modular_finger_hand"
  },
  {
    "id": "bc_laser_pointer_cyberfinger",
    "name": "Laser Pointer Cyberfinger",
    "type": "Cyberfinger",
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] Laser pointer. 4+ can force DV13 Resist Torture/Drugs. Requires Modular Finger Cyberhand.",
    "parentType": "bc_modular_finger_hand"
  },
  {
    "id": "bc_wirecutter_cyberfinger",
    "name": "Wirecutter/Scissor Cyberfingers",
    "type": "Cyberfinger",
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] Retractable blades, also a Poor Quality Light Melee Weapon. Requires Modular Finger Cyberhand.",
    "parentType": "bc_modular_finger_hand"
  },
  {
    "id": "bc_homing_tracer_cyberfinger",
    "name": "Homing Tracer Cyberfinger",
    "type": "Cyberfinger",
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] Points toward linked tracer within 1 mile. Requires Modular Finger Cyberhand.",
    "parentType": "bc_modular_finger_hand"
  },
  {
    "id": "bc_mini_air_cyberfinger",
    "name": "Mini Air Supply Cyberfinger",
    "type": "Cyberfinger",
    "hc": 2,
    "cost": 500,
    "desc": "[CRB] 10 min air supply, 1 hr to refill. Requires Modular Finger Cyberhand.",
    "parentType": "bc_modular_finger_hand"
  },
  {
    "id": "bc_one_shot_cyberfinger",
    "name": "One Shot Special Cyberfinger",
    "type": "Cyberfinger",
    "hc": 7,
    "cost": 100,
    "desc": "[CRB] Single-shot Exotic Heavy Pistol concealed in finger. Requires Modular Finger Cyberhand.",
    "parentType": "bc_modular_finger_hand"
  },
  {
    "id": "bc_spray_paint_cyberfinger",
    "name": "Spray Paint Cyberfinger",
    "type": "Cyberfinger",
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] Spray can concealed within the Cyberfinger. Requires Modular Finger Cyberhand.",
    "parentType": "bc_modular_finger_hand"
  },
  {
    "id": "bc_squirt_cyberfinger",
    "name": "Squirt Cyberfinger",
    "type": "Cyberfinger",
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] Dispenses liquids like sanitizer or perfume. Requires Modular Finger Cyberhand.",
    "parentType": "bc_modular_finger_hand"
  },
  {
    "id": "chemskin",
  ...
  },
  {
    ...
    "hc": 14,
    "cost": 500,
    "desc": "[CRB] Boosted reflexes. +2 to Initiative.",
    "parentType": "neural_link"
  },
  {
    "id": "sandevistan",
    ...
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Activate for +3 to Initiative for 1 min (Action, 1hr cooldown).",
    "parentType": "neural_link"
  },
  {
    "id": "image_enhance",
    "name": "Image Enhance",
    "type": "Cybereye Option",
    "hc": 2,
    "cost": 500,
    "desc": "[CRB] Enhanced vision processing.",
    "parentType": "cybereye",
    "bonus": {
      "skills": {
        "perception": 2,
        "lip_reading": 2,
        "conceal_reveal_object": 2
      }
    }
  },
  {
    ...
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] +1 to Aimed Shot checks. Requires paired Cybereyes.",
    "parentType": "cybereye"
  },
  {
    "id": "teleoptics",
    ...
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] +1 to checks vs targets 51m/yds+.",
    "parentType": "cybereye"
  },
  {
    "id": "low_light_cybereye",
    "name": "Low Light/IR/UV Cybereye",
    "type": "Cybereye Option",
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] Negate darkness/smoke/fog penalties. Requires Cybereye.",
    "parentType": "cybereye"
  },
  {
    "id": "amplified_hearing",
    "name": "Amplified Hearing",
    "type": "Cyberaudio Option",
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] Enhanced hearing. Requires Cyberaudio.",
    "parentType": "cyberaudio",
    "bonus": {
      "skills": {
        "perception": 2
  ...
  },
  {
    ...
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] Detect lies. Requires Cyberaudio.",
    "parentType": "cyberaudio",
    "bonus": {
      "skills": {
        "human_perception": 2,
  ...
  },
  {
    ...
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] Voice modulator. Requires Cyberaudio.",
    "parentType": "cyberaudio",
    "bonus": {
      "skills": {
        "acting": 2,
  ...
  },
  {
    ...
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] Heal 2x BODY HP per day when resting."
  },
  {
  ...
  },
  {
    ...
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] Filters bloodborne toxins.",
    "bonus": {
      "skills": {
  ...
  },
  {
    ...
    "hc": 2,
    "cost": 100,
    "desc": "[CRB] Immune to inhaled toxins and gases."
  },
  {
    ...
    "hc": 7,
    "cost": 1000,
    "desc": "[CRB] Detect moving objects within 50m/yds (not through cover)."
  },
  {
    "id": "medscanner",
    "name": "Medscanner",
    ...
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] Medical diagnostic scanner in cyberarm.",
    "parentType": "cyberarm",
    "bonus": {
      "skills": {
        "first_aid": 2,
  ...
  {
    "id": "techscanner_cyberarm",
    "name": "Techscanner",
    "type": "Cyberarm Option",
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] Technical diagnostic scanner in cyberarm.",
    "parentType": "cyberarm",
    "bonus": {
      "skills": {
        "basic_tech": 2,
  ...
  },
  {
    ...
    "hc": 2,
    "cost": 500,
    "desc": "[CRB] Mirror-chrome finish. +2 Wardrobe & Style.",
    "parentType": "cyberarm",
    "bonus": {
      "skills": {
        "wardrobe_style": 2
  ...
  },
  {
    ...
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] +6m/yds movement when using Run Action.",
    "parentType": "cyberleg"
  },
  {
    ...
    "hc": 7,
    "cost": 100,
    "desc": "[CRB] Remove/install a Cyberarm as an Action."
  },
  {
    "id": "rippers",
    "name": "Rippers",
    ...
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] Retractable carbo-glass claws. Medium Melee Weapon.",
    "parentType": "cyberarm"
  },
  {
    "id": "wolvers",
    ...
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] Large forearm blades. Heavy Melee Weapon.",
    "parentType": "cyberarm"
  },
  {
    "id": "scratchers",
    ...
    "hc": 2,
    "cost": 100,
    "desc": "[CRB] Retractable carbo-glass fingernails. Light Melee Weapon.",
    "parentType": "cyberarm"
  },
  {
    ...
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] Load one dose of Street Drug. Inject as Action. With Biomonitor, auto-inject on Initiative/Critical Injury/Wound State."
  },
  {
    "id": "pursuitech_gas_jet",
    "name": "Pursuit Security Inc. Gas Jet",
    "type": "Cyberarm Option",
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Aerosol gas launcher (3 doses). Acts as 1H Exotic Shotgun. Applies loaded substance. Requires Cyberarm, 2 Option Slots.",
    "parentType": "cyberarm"
  },
  {
    ...
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Manage hunger via Biomonitor. Ignore HL from long-term environmental stress. Starvation still fatal after 7 days. Requires Biomonitor."
  },
  {
    "id": "cyberpillow",
    "name": "Cyberpillow",
    ...
    "hc": 0,
    "cost": 100,
    "desc": "[CRB] Pop-out pillow for napping. Requires Cyberarm.",
    "parentType": "cyberarm"
  },
  {
    ...
    "hc": 7,
    "cost": 100,
    "desc": "[CRB] Subcutaneous flexible screen. Turns body part into display for linked Agent or Memory Chip."
  },
  {
    ...
    "hc": 2,
    "cost": 100,
    "desc": "[CRB] Hologram projector in palm. Can be installed in a meat arm.",
    "parentType": "cyberarm"
  },
  {
    "id": "kill_display",
    ...
    "hc": 0,
    "cost": 100,
    "desc": "[CRB] Subdermal 'KILLS: #' display. Self-reported via Agent.",
    "bonus": {
      "skills": {
        "wardrobe_style": 2
      }
  ...
  {
    "id": "leads_turn_on_show_off_nails",
    "name": "Lead's Turn-On-Show-Off Nails",
    "type": "Fashionware",
    "hc": 0,
    "cost": 100,
    "desc": "[CRB] Programmable lighted fingernails. Works on meat or cyberware hands.",
    "bonus": {
      "skills": {
        "wardrobe_style": 2
      }
  ...
  },
  {
    ...
    "hc": 0,
    "cost": 100,
    "desc": "[CRB] Eye color changes with mood (red=anger, blue=sadness, etc.). Requires Neural Link.",
    "parentType": "neural_link"
  },
  {
    "id": "neutongue",
    ...
    "hc": 7,
    "cost": 100,
    "desc": "[CRB] Cybernetic tongue. Add virtual seasoning to food via linked Agent."
  },
  {
    ...
    "hc": 2,
    "cost": 100,
    "desc": "[CRB] Adjustable foot size/shape. Eliminates penalty from ill-fitting footwear. Can be installed in a meat leg.",
    "parentType": "cyberleg"
  },
  {
    "id": "talon_feet",
    ...
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] Retractable foot talons. Light Melee Weapon (1d6). Requires Cyberlegs.",
    "parentType": "cyberleg"
  },
  {
    "id": "jump_boosters",
    ...
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] Hydraulic leg boosters. +3d6 dmg vs cover with leg attacks. Requires Cyberlegs.",
    "parentType": "cyberleg"
  },
  {
    ...
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] Rotisserie oven in forearm. Warms PersonalPak Kibble cylinders. Requires Cyberarm.",
    "parentType": "cyberarm"
  },
  {
    "id": "pursuitech_personal_shredder",
    "name": "Pursuit Security Inc. Personal Shredder",
    "type": "Cyberarm Option",
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] Cross-cut shredder in cyberarm with internal reservoir. Requires Cyberarm.",
    "parentType": "cyberarm"
  },
  {
    ...
    "hc": 0,
    "cost": 50,
    "desc": "[CRB] Illuminated ad on cyberlimb. Pays 20eb/month. Does not take an Option Slot. Requires Cyberarm or Cyberleg."
  },
  {
    ...
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Cyberscanner installed in a Cyberarm. Requires 2 Option Slots.",
    "parentType": "cyberarm"
  },
  {
    "id": "chainripp",
    ...
    "hc": 14,
    "cost": 500,
    "desc": "[CRB] Retractable chainsaw in wrist. Can be revved into Excellent Quality Very Heavy Melee Weapon. Takes 4 Option Slots.",
    "parentType": "cyberarm"
  },
  {
    "id": "gang_jazzler",
    ...
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Electrode needle in arm. On successful Choke, force DV13 Resist Torture/Drugs or Unconscious 1 min.",
    "parentType": "cyberarm"
  },
  {
    "id": "bug_eye",
    ...
    "hc": 14,
    "cost": 500,
    "desc": "[CRB] Oversized Cybereye. Contains 5 slots for Cybereye Options.",
    "slots": 5,
    "parentType": "cybereye",
    "bodyPart": "eye",
    "takesBoth": true
  },
  {
    ...
    "hc": 3,
    "cost": 500,
    "desc": "[CRB] Slow vitals to appear dead. DV17-21 to detect. -4 to all Actions while active.",
    "parentType": "neural_link"
  },
  {
    "id": "monovision",
    ...
    "hc": 14,
    "cost": 500,
    "desc": "[CRB] Single wide-angle cyberoptic visor. Contains 3 slots. Options count as paired.",
    "slots": 3,
    "parentType": "cybereye",
    "bodyPart": "eye",
    "takesBoth": true
  },
  {
    ...
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Retractable Anti-Dazzle mirrorshades built into brow. Immune to flashblindness."
  },
  {
    "id": "watch_man",
    ...
    "hc": 3,
    "cost": 100,
    "desc": "[CRB] Agent built into cyberarm with flip-up screen.",
    "parentType": "cyberarm"
  },
  {
    "id": "poser_chip",
    ...
    "hc": 14,
    "cost": 500,
    "desc": "[CRB] +4 to Acting to impersonate persona. +5 if roleplayed. Famous persona: 500eb. Private: 1000eb.",
    "parentType": "neural_link"
  },
  {
    "id": "arc_thrower",
    ...
    "hc": 14,
    "cost": 1000,
    "desc": "[CRB] 0 Option slots. No hand. Exotic Shotgun (Heavy Weapons), 4d6 Shell fire, 32 charges. Cannot Crit or ablate armor.",
    "bodyPart": "arm"
  },
  {
    "id": "microwaldo",
    ...
    "hc": 7,
    "cost": 1000,
    "desc": "[CRB] +1 to Surgery Skill. Neuralware and Cyberarm Option.",
    "parentType": "cyberarm",
    "bonus": {
      "skills": {
        "surgery": 1
  ...
  },
  {
    ...
    "hc": 7,
    "cost": 1000,
    "desc": "[CRB] Skinweave. Body and Head SP7. Self-repairs to full after 10 min without strenuous activity."
  },
  {
    ...
    "hc": 14,
    "cost": 1000,
    "desc": "[CRB] Paired Cyberlegs. 3 Option Slots each. Pre-installed Talon Feet.",
    "bodyPart": "leg",
    "slots": 3,
    "parentType": "cyberleg",
    "takesBoth": true
  },
  {
    ...
    "hc": 14,
    "cost": 1000,
    "desc": "[CRB] Replace meat face with mounting. Comes with 1 personalized Faceplate. Additional: 100eb."
  },
  {
    "id": "quick_digits",
  ...
  },
  {
    ...
    "hc": 14,
    "cost": 1000,
    "desc": "[CRB] Paired Cyberlegs. 2 Option Slots each. Pre-installed Jump Boosters. +3d6 dmg vs cover with leg attacks.",
    "bodyPart": "leg",
    "slots": 2,
    "parentType": "cyberleg",
    "takesBoth": true
  },
  {
    ...
    "hc": 7,
    "cost": 1000,
    "desc": "[CRB] Requires 3 Option Slots. Immune to Spinal Injury. Hardened. +1 Contortionist. Can house Cybersnake.",
    "bonus": {
      "skills": {
        "contortionist": 1
      }
  ...
  {
    "id": "cyberconductor_integrated",
    "name": "Zetatech CyberConductor, Integrated",
    "type": "Borgware",
    "hc": 14,
    "cost": 1000,
    "desc": "[CRB] FBC only. All cyberdecks connected. Switch between them with no HP damage. Requires 3 Option Slots."
  },
  {
    ...
    "hc": 7,
    "cost": 500,
    "desc": "[CRB] Retractable cat claws. Excellent Quality Medium Melee, 1d6, ignores armor SP<11. Cannot hold items while active.",
    "parentType": "cyberarm"
  },
  {
    "id": "sparkle_ize",
    ...
    "hc": 3,
    "cost": 250,
    "desc": "[CRB] Big-eyes look. Flashlight built in. Paired: DV15 Resist or Damaged Eye for 1 min. Requires 2 Option Slots.",
    "parentType": "cybereye"
  },
  {
    "id": "dynalar_xtradex_glove",
    "name": "Dynalar Xtra-Dex Smart Glove",
    "type": "Cyberarm Option",
    "hc": 0,
    "cost": 1000,
    "desc": "[CRB] 2 Option Slots. Counts as Modular Finger Cyberhand (up to 5 Cyberfingers). Requires Interface Plugs.",
    "parentType": "cyberarm"
  }
],
